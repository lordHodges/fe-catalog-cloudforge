...
const translations: Record<SupportedLanguage, Record<string, string>> = {
  es: {
    ...
    'CATALOG.HERO_DESC': 'Infraestructura cloud de alto rendimiento, microservicios empresariales y soluciones serverless lista para desplegar.',
    ...
    'CATALOG.NO_PRODUCTS_DESC': 'Intenta ajustar tu búsqueda o filtro de categoría.',
    ...
    'CART.EMPTY_DESC': '¡Explora el catálogo y añade soluciones cloud de alto rendimiento!',
  ...
  en: {
    'CATALOG.HERO_TITLE': 'CloudForge Marketplace',
    'CATALOG.HERO_DESC': 'High-performance cloud infrastructure, enterprise microservices, and serverless solutions ready to deploy.',
    ...
    'CART.EMPTY_DESC': 'Explore the catalog and add high-performance cloud solutions!',
