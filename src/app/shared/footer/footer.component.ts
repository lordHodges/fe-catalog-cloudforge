    ...
    <footer class="footer mt-auto py-4 border-top border-purple">
      <div class="container text-center">
        <div class="d-flex justify-content-center align-items-center gap-2 mb-2">
          ...
          <span class="fw-bold text-light fs-5 brand-text">CloudForge Marketplace</span>
        </div>
        <p class="text-secondary small mb-0">
          &copy; {{ currentYear }} CloudForge Inc. Todos los derechos reservados. Impulsado por Angular Signals & NestJS.
        </p>
      </div>
    </footer>
  `,
