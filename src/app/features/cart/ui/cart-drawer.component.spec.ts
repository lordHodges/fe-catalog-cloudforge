...
describe("CartDrawerComponent", () => {
  ...
  it("should not render drawer in DOM when isCartOpen is false", () => {
    ...
    fixture.detectChanges();
    const drawerEl = fixture.nativeElement.querySelector(
  ...
  it("should render cart items, total amount, and enabled checkout button when items are added", () => {
    ...
    const cartItem = fixture.nativeElement.querySelector(
      '[data-testid="cart-item"]',
    );
    const qtyText = fixture.nativeElement.querySelector(
      '[data-testid="item-quantity"]',
    );
    const cartTotal = fixture.nativeElement.querySelector(
  ...
  it("should update quantity when increment and decrement buttons are clicked", () => {
    ...
    const incBtn = fixture.nativeElement.querySelector(
    ...
    const decBtn = fixture.nativeElement.querySelector(
