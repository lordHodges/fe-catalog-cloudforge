...
describe('CheckoutComponent UI', () => {
  ...
  it('should render checkout form with all data-testid inputs', () => {
    ...
    expect(compiled.querySelector('[data-testid="checkout-form"]')).toBeTruthy();
    expect(compiled.querySelector('[data-testid="customer-name"]')).toBeTruthy();
    expect(compiled.querySelector('[data-testid="customer-email"]')).toBeTruthy();
    expect(compiled.querySelector('[data-testid="customer-address"]')).toBeTruthy();
    expect(compiled.querySelector('[data-testid="customer-city"]')).toBeTruthy();
    expect(compiled.querySelector('[data-testid="customer-zip"]')).toBeTruthy();
    expect(compiled.querySelector('[data-testid="submit-order-btn"]')).toBeTruthy();
  });
  ...
  it('should trigger submitOrder on form submit when inputs are valid and cart is not empty', () => {
    ...
    component.onSubmit();
    expect(mockCheckoutStore.submitOrder).toHaveBeenCalledWith(component.customer);
  });
  ...
  it('should display order confirmation screen when orderConfirmation signal is populated', () => {
    ...
    const compiled = fixture.nativeElement as HTMLElement;
    expect(compiled.querySelector('[data-testid="order-confirmation"]')).toBeTruthy();
    expect(compiled.querySelector('[data-testid="order-success"]')).toBeTruthy();
