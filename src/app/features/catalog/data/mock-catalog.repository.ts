...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    description:
      "Instancia cloud de prueba de alto rendimiento para entornos Cloudforge Marketplace.",
    price: 15000,
  ...
  },
  {
    ...
    description:
      "Cluster administrado k8s con autoscaling de nodos y monitoreo Prometheus integrado.",
    price: 45000,
    category: "Infrastructure",
  ...
  },
  {
    ...
    description:
      "Base de datos PostgreSQL altamente disponible con failover automático y backups continuos.",
    price: 25000,
    category: "Databases",
  ...
  },
  {
    ...
    description:
      "Bus de eventos distribuido de ultra baja latencia para arquitecturas reactivas.",
    price: 12000,
    category: "Messaging",
  ...
  },
  {
    ...
    description:
      "Acelerador de búsqueda vectorial con GPUs NVIDIA H100 para LLMs e IA generativa.",
    price: 85000,
    category: "Compute",
  ...
  },
  {
    ...
    description:
      "Servicio de auditoría de seguridad en tiempo real y prevención de amenazas.",
    price: 18000,
    category: "Security",
