...
describe("CatalogComponent", () => {
  ...
  it("should render product cards with product-name, product-price, product-stock, add-to-cart-btn", () => {
    const compiled = fixture.nativeElement as HTMLElement;
    const productCards = compiled.querySelectorAll(
    ...
    expect(
      firstCard.querySelector('[data-testid="product-name"]'),
    ).toBeTruthy();
    expect(
      firstCard.querySelector('[data-testid="product-price"]'),
    ).toBeTruthy();
    expect(
      firstCard.querySelector('[data-testid="product-stock"]'),
    ).toBeTruthy();
    expect(
      firstCard.querySelector('[data-testid="add-to-cart-btn"]'),
    ).toBeTruthy();
  });
