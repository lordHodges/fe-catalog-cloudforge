          ...
          <div class="col">
            ...
            >
              ...
              >
                ...
                />
                <span
                  class="position-absolute top-0 end-0 m-3 badge badge-category rounded-pill"
                >
                  {{ product.category }}
                </span>
              </div>
              ...
              <div class="card-body d-flex flex-column p-4">
                ...
                <p
                  class="card-text text-secondary small flex-grow-1 line-clamp-3"
                >
                  {{ product.description }}
                </p>
...
export class CatalogComponent implements OnInit {
  ...
  handleImageError(event: Event): void {
    ...
    img.src =
      'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200"><rect width="200" height="200" fill="%231a0c36"/><path d="M60,130 L100,70 L140,130 Z" fill="%236f42c1"/><circle cx="130" cy="70" r="15" fill="%2300e5ff"/><text x="100" y="165" font-family="sans-serif" font-size="14" fill="%2300e5ff" text-anchor="middle">CloudForge Service</text></svg>';
  }
}
